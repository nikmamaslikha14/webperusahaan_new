    ...
    <div id="gallery">
      <div id="gallery-content">
        <div id="gallery-content-center">
             <img src="<?php echo base_url().'assets/images/40.jpg'?>" class="all img-fluid" alt="#" />
             <img src="<?php echo base_url().'assets/images/41.jpg'?>" class="all img-fluid" alt="#" />
             <img src="<?php echo base_url().'assets/images/42.jpg'?>" class="all img-fluid" alt="#" />
             <img src="<?php echo base_url().'assets/images/43.jpg'?>" class="all img-fluid" alt="#" />
              <img src="<?php echo base_url().'assets/images/40.jpg'?>" class="all img-fluid" alt="#" />
              <img src="<?php echo base_url().'assets/images/44.jpg'?>" class="all img-fluid" alt="#" />
            </a>
       </div>
     </div>
   </div>
